...
The help file project named ``Plexdata.CapacityConverter.help.shfbproj`` has been created using [Sandcastle Help File Builder](https://ewsoftware.github.io/SHFB/html/bd1ddb51-1c4f-434f-bb1a-ce2135d3a909.htm) version v2018.12.10.0.
...
* As first, you should create a copy of the help file project ``Plexdata.CapacityConverter.help.shfbproj`` and rename it, for instance into ``Plexdata.CapacityConverter.html.shfbproj``. 
